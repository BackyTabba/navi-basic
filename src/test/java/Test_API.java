...
public class Test_API {
    ...
    List<String> point = Arrays.asList("51.968856,7.595637", "51.965003,7.600332"); // List<String> | Specify multiple points for which the route should be calculated. The order is important. Specify at least two points.
...
try {
        RouteResponse result = apiInstance.routeGet(point, pointsEncoded, key, locale, instructions, vehicle);
